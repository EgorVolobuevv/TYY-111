...
namespace Работа_2
{
    internal class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("Присвоение значения переменной упрощённого арифметического выражения, набранного из сочетания переменных, которым присвоены фрагменты исходного арифметического выражения: " + rez);
        }
    }
}
